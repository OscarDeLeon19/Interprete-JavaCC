...
public class Gramatica implements GramaticaConstants {
 ...
 Instruccion e;
  ...
  final public Instruccion Para() throws ParseException {
 Instruccion d; Instruccion e; Iteracion i; ArrayList<Instruccion> cuerpoCiclo = new ArrayList<Instruccion>();
    ...
    cuerpoCiclo = BloqueCiclo();
     {if (true) return new Para(Tipo.PARA, (Declaracion) d, e, i, cuerpoCiclo, token.beginLine, token.beginColumn);}
    throw new Error("Missing return statement in function");
  }

  final public Instruccion DeclaracionCiclo() throws ParseException {
 Tipo t; Token tok; Instruccion e;
  ...
  final public Iteracion Aumentar() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INCREMENTO:
      jj_consume_token(INCREMENTO);
                  {if (true) return new Iteracion(Tipo.INCREMENTO, token.beginLine, token.beginColumn, Tipo.ITERACION);}
      break;
    case DECREMENTO:
      jj_consume_token(DECREMENTO);
                    {if (true) return new Iteracion(Tipo.DECREMENTO, token.beginLine, token.beginColumn, Tipo.ITERACION);}
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  final public ArrayList<Instruccion> BloqueCiclo() throws ParseException {
 ArrayList<Instruccion> instrucciones = new ArrayList<Instruccion>(); Instruccion e;
  ...
  final public Instruccion InstruccionCiclo() throws ParseException {
 Instruccion e;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CADENA:
    case INT:
  ...
  final public Instruccion Si() throws ParseException {
    ...
    default:
      ...
      ;
         ...
         {if (true) return new Si(Tipo.SI, e, cuerpoSi, cuerpoElse, token.beginLine, token.beginColumn);}
    throw new Error("Missing return statement in function");
  }

  final public ArrayList<Instruccion> BloqueSi() throws ParseException {
 ArrayList<Instruccion> instrucciones = new ArrayList<Instruccion>(); Instruccion e;
    jj_consume_token(LLAVE_I);
    label_3:
    while (true) {
  ...
  final public Instruccion InstruccionSi() throws ParseException {
 Instruccion e;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CADENA:
    case INT:
